...
🔒 Versions You SHOULD NOT Change

Changing these often causes silent test failures:

Package	Why
prisma / @prisma/client	Must match exactly
@prisma/adapter-neon	Version-coupled to Prisma
vitest	Tests assume v4 behavior
openai
